...
<area alt="Coordinaci&oacute;n General de Lenguas" shape="rect" coords="550,0,1300,120" href="http://www.cgl.unam.mx">
	...
	<div id="menu">			
					<ul class="menu">
						</br><b style="color: #000066;">Paquetes Didácticos 2014-15</b>										
					</ul>
	</div>
		...
		<style type='text/css'>
			...
			<div class=tabla_centro>
				<form action="control_paq.php" method="post">
					...
					<span style="color:red"><b><br/>No se encuentra tu número de cuenta<br/>Intenta nuevamente<br/>O pide que se te de de alta en el sistema, en la Mediateca de tu Plantel</b></span>
					<?php }else{?>
