	...
	//**********************************************Sección Tercer Semestre*************************************************************************************************************
			...
			if($alfa==3){
				...
				<tr align='center'>		
						...
						<td width='9%'><b>Simple present be</b></td>
			...
			if(empty($_POST[Cuenta])){
				...
				$sql=$conexion->consulta($sql);			
					...
					<tr align='center'>	
						<td width='7%'>".$row["Cuenta"]."</td>	
						<td width='7%'>".$row["Nombre"]."</td>";
						$conexion->imprime($row,'NO','t1',7, 'http://www.hugix.comli.com/Pqt/pdfs1y4/PD910ToBe.pdf','#08088A');
						$conexion->imprime($row,'NO','t2',7,'http://www.hugix.comli.com/Pqt/pdfs1y4/PD5PersonalPronouns.pdf','#08088A');
						$conexion->imprime($row,'NO','t3',7,'http://www.hugix.comli.com/Pqt/pdfs1y4/PD910ToBe.pdf','#08088A');
						$conexion->imprime($row,'NO','t4',7,'http://www.hugix.comli.com/Pqt/pdfs1y4/Nationalities.pdf','#08088A');
						$conexion->imprime($row,'NO','t5',7,'http://www.hugix.comli.com/Pqt/pdfs1y4/PD6PossessiveAdj.pdf','#08088A');
						$conexion->imprime($row,'NO','t6',7,'http://www.hugix.comli.com/Pqt/pdfs1y4/PD14Whquestions.pdf','#08088A');
						$conexion->imprime($row,'NO','t7',7,'http://www.hugix.comli.com/Pqt/pdfs1y4/PD2Articles.pdf','#08088A');
						$conexion->imprime($row,'NO','t8',7, 'http://www.hugix.comli.com/Pqt/pdfs1y4/FamilyR.pdf','#08088A');
						$conexion->imprime($row,'NO','t9',7, 'http://www.hugix.comli.com/Pqt/pdfs1y4/PD1Alphabet.pdf','#08088A');
						$conexion->imprime($row,'NO','t10',7, '#','#08088A');
						$conexion->imprime($row,'NO','t11',7,'#','#08088A');
						$conexion->imprime($row,'NO SATISFACTORIO','t12',10, '#','#08088A');		
						echo"
	...
	//**********************************************Sección Tercer Semestre Profesor*****************************************************************************************************
			if($alfa=="p3"){
				...
				<tr align='center'>	
					<td width='9%'>".$row["Cuenta"]."</td>	
					<td width='10%'>".$row["Nombre"]."</td>";
					$conexion->imprime($row,'NO','t1',9, 'http://www.hugix.comli.com/Pqt/pdfs1y4/PD910ToBe.pdf','#08088A');
					$conexion->imprime($row,'NO','t10',9,'http://www.hugix.comli.com/Pqt/pdf3/SimpleOtherVerbs.pdf','#08088A');
					$conexion->imprime($row,'NO','t11',9,'http://www.hugix.comli.com/Pqt/pdf5/PD4y5ComparSuperlatives.pdf','#08088A');
					$conexion->imprime($row,'NO','t13',9,'#','#08088A');
					$conexion->imprime($row,'NO','t14',9,'http://www.hugix.comli.com/Pqt/pdf3/PD2PaSitherewaswere.pdf','#08088A');
					$conexion->imprime($row,'NO','t15',9,'http://www.hugix.comli.com/Pqt/pdf3/PD4PaSidescriptions.pdf','#08088A');
					$conexion->imprime($row,'NO','t16',9,'#','#08088A');
					$conexion->imprime($row,'NO','t17',9, '#','#08088A');
					$conexion->imprime($row,'NO SATISFACTORIO','t12',9, '#','#08088A');		
					echo"
				</tr>";
	...
	//**********************************************Sección Quinto Año Profesor*****************************************************************************************************
			if($alfa=="p5"){
				...
				<tr align='center'>	
					...
					<td width='10%'>".$row["Nombre"]."</td>";
					$conexion->imprime($row,'NO','t1',9, 'http://www.hugix.comli.com/Pqt/pdfs1y4/PD910ToBe.pdf','#08088A');
					$conexion->imprime($row,'NO','t2',9,'http://www.hugix.comli.com/Pqt/pdfs1y4/PD4DdemonsAdj.pdf','#08088A');
					$conexion->imprime($row,'NO','t3',9,'http://www.hugix.comli.com/Pqt/pdfs1y4/Simple%20past.pdf','#08088A');
					$conexion->imprime($row,'NO','t4',9,'http://www.hugix.comli.com/Pqt/pdfs1y4/Simple%20past.pdf','#08088A');
					$conexion->imprime($row,'NO','t5',9,'http://www.hugix.comli.com/Pqt/pdf5/Modal%20verbs.pdf','#08088A');
					$conexion->imprime($row,'NO','t10',9,'#','#08088A');
					$conexion->imprime($row,'NO','t11',9,'#','#08088A');
					$conexion->imprime($row,'NO','t13',9, 'http://www.hugix.comli.com/Pqt/pdfs1y4/PD13PrSidailyroutines.pdf','#08088A');
					$conexion->imprime($row,'NO SATISFACTORIO','t12',9, '#','#08088A');			
					echo"
				</tr>";
				}//Termina el while de la DB
	...
	//**********************************************Sección Sexto Año Profesor*****************************************************************************************************
			if($alfa=="p6"){
				...
				<tr align='center'>	
					<td width='20%'>".$row["Cuenta"]."</td>	
					<td width='20%'>".$row["Nombre"]."</td>";
					$conexion->imprime($row,'NO','t10',20, 'http://www.hugix.comli.com/Pqt/pdf6/PD4Inferencias.pdf','#08088A');
					$conexion->imprime($row,'NO','t11',20,'http://www.hugix.comli.com/Pqt/pdf6/PD2LecturaGlobal.pdf','#08088A');
					$conexion->imprime($row,'NO SATISFACTORIO','t12',20, '#','#08088A');			
					echo"
				</tr>";
				}//Termina el while de la DB
