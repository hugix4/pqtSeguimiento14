...
<area alt="Coordinaci&oacute;n General de Lenguas" shape="rect" coords="550,0,1300,120" href="http://www.cgl.unam.mx">
	...
	<div id="menu">			
					<ul class="menu">
						</br><b style="color: #000066;">Paquetes Didácticos 2014</b>										
					</ul>
	</div>
...
<tr>
	...
	<?php if($_GET["errorusuario"]=="si"){?>		
		<span style="color:red"><b><br/>No se encuentra tu número de cuenta<br/>Intenta nuevamente<br/>O envia tus datos(#Cuenta, nombre completo,plantel, grupo) pidiendo se te de de alta en el sistema a hugix4@live.com</b></span>
			<?php }else{?>
				</br></br><b>Teclea tu número de cuenta<b/>
			<?php } ?></td>
		</tr><br><br>
		<tr>
